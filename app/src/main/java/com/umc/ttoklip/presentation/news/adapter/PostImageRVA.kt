...
import com.umc.ttoklip.databinding.ItemPostImageBinding

class PostImageRVA( val onclick :(List<ImageUrl>)->Unit) : ListAdapter<ImageUrl, PostImageRVA.ItemViewHolder>(differ) {
